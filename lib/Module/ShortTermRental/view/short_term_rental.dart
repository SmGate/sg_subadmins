...
class ShortTermRentalScreen extends StatefulWidget {
  const ShortTermRentalScreen({super.key});

  @override
  State<ShortTermRentalScreen> createState() => _ShortTermRentalScreenState();
}

class _ShortTermRentalScreenState extends State<ShortTermRentalScreen> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyTextFormField(
                          ...
                          controller:
                              shortTermRentalController.guestNameController,
                          labelText: 'Guest Name',
                          hintText: 'Guest Name',
                        ),
                        SizedBox(height: 10),
                        buildTextLabel('Guest Phone'),
                        SizedBox(
                          height: 10,
                        ),
                        MyTextFormField(
                          ...
                          padding: EdgeInsets.only(left: 0, right: 0),
                          controller:
                              shortTermRentalController.guestPhoneController,
                          labelText: 'Guest Phone',
                          hintText: 'Guest Phone',
                        ),
                        SizedBox(height: 10),
                        buildTextLabel('Guest Cnic'),
                        SizedBox(
                          height: 10,
                        ),
                        MyTextFormField(
                          ...
                          padding: EdgeInsets.only(left: 0, right: 0),
                          controller:
                              shortTermRentalController.guestCNicController,
                          labelText: 'Guest Cnic',
                          hintText: 'Guest CNic',
                        ),
                        SizedBox(height: 10),
                        buildTextLabel('Vehicle No'),
                        SizedBox(
                          height: 10,
                        ),
                        MyTextFormField(
                          ...
                          padding: EdgeInsets.only(left: 0, right: 0),
                          controller:
                              shortTermRentalController.vehicleNoController,
                          labelText: 'Vehicle No',
                          hintText: 'Vehicle No',
                        ),
                        SizedBox(height: 10),
                        buildTextLabel('Description'),
                        SizedBox(
                          height: 10,
                        ),
                        MyTextFormField(
                          ...
                          padding: EdgeInsets.only(left: 0, right: 0),
                          controller:
                              shortTermRentalController.descriptionController,
                          labelText: 'Description',
                          hintText: 'Description',
                        ),
                        SizedBox(height: 10),
                        buildTextLabel('Price'),
                        SizedBox(
                          height: 10,
                        ),
                        MyTextFormField(
                          ...
                          width: double.infinity,
                          padding: EdgeInsets.only(left: 0, right: 0),
                          controller: shortTermRentalController.priceController,
                          labelText: 'Price',
                          hintText: 'Price',
                        ),
                        SizedBox(height: 10),
                          ...
                          child: Obx(() => MyButton(
                              ...
                              onPressed: () {
                                ...
                                if (selectedImage == null) {
                                  Get.snackbar(
                                      'Error', 'Please select a guest image.');
                                  return;
                                }
                                ...
                                if (shortTermRentalController
                                  ...
                                  String formattedCheckInDate =
                                      DateFormat('yyyy-MM-dd').format(
                                          (checkInDate ?? DateTime.now()).toLocal());
                                  String formattedCheckOutDate =
                                      DateFormat('yyyy-MM-dd').format(
                                          (checkOutDate ?? DateTime.now()).toLocal());

                                  shortTermRentalController.addShortTermRental(
                                      guestName: shortTermRentalController
                                          .guestNameController.text,
                                      guestPhone: shortTermRentalController
                                          .guestPhoneController.text,
                                      guestCnic: shortTermRentalController
                                          .guestCNicController.text,
                                      cnicPhoto: selectedImage!,
                                      checkInDate: formattedCheckInDate,
                                      checkOutDate: formattedCheckOutDate,
                                      totalPrice: shortTermRentalController
                                          .priceController.text,
                                      description: shortTermRentalController
                                          .descriptionController.text,
                                      vehicleNumber: shortTermRentalController
                                          .vehicleNoController.text,
                                      apartmentId: shortTermRentalController
                                          .selectedApartmentId.value
                                          .toString(),
                                      buildingId: shortTermRentalController
                                          .selectedBuildingId.value
                                          .toString(),
                                      societyId: shortTermRentalController
                                          .userdata.societyid
                                          .toString(),
                                      subadminId: shortTermRentalController.userdata.userid
                                          .toString());
                                }
                              })),
                        )
